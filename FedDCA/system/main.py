...
from flcore.servers.serverHLG import FedHLG
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        elif args.algorithm == "FedHLG":
            args.head = copy.deepcopy(args.model.fc)
            args.model.fc = nn.Identity()
            args.model = BaseHeadSplit(args.model, args.head)
            server = FedHLG(args, i)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-algo', "--algorithm", type=str, default="FedHLG")
    ...
    # FedHLG
    # parser.add_argument("--second_stage_epochs", type=int, default=1,
    #                     help="Local epochs for the second stage of training")
    # parser.add_argument("--threshold", type=float, default=0.1,
    #                     help="Threshold for weight adjustment convergence")
    ...
    # parser.add_argument('-mub', "--mu_base", type=float, default=0.0)
    parser.add_argument('-lmi', "--lamda_mi", type=float, default=1.0)
    parser.add_argument('-lcl', "--lamda_cl", type=float, default=1.0)
